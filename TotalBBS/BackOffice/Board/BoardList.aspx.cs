...
namespace TotalBBS.BackOffice.Board
{
    public partial class BoardList : AdminBasePage
    {
        ...
        private void GetPageDefaultSetting()
        {
            ...
            this.lbtnDelete.Text = "<span>삭제</span>";
        ...
        private void GetListInfo(int PagePerData, int CurrentPage, string BoardCategory, string FIELD, string KEY)
        {
            ...
            List<BoardBean> GetList = oWS.TOTALBBS_BOARD_INFO_SEL(PagePerData, CurrentPage, BoardCategory, "L", FIELD, strKey);

            int BoardTotalCnt = oWS.TOTALBBS_BOARD_INFO_COUNT_SEL(PagePerData, CurrentPage, BoardCategory, "T", FIELD, strKey);
