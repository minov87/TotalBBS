...
namespace TotalBBS.Common.Data
{
    public sealed class SQLHelper
    {
        ...
        public static DataTable ExecuteDataTable(string connectionString, string spName, params object[] values)
        {
            return ExecuteDataset(connectionString, spName, values).Tables[0];
        }
